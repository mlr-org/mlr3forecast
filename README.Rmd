...
machine learning forecasting, i.e. using regression learners with lag features
for recursive one-step-ahead prediction.
...
and longitudinal data is often referred to as local and global forecasting.
