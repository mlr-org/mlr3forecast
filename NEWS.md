...
* feat: `tgen("seasonal")` is a new task generator for series with a linear trend, sinusoidal seasonality, and Gaussian noise, with additive or multiplicative seasonality and optional keyed panels.
