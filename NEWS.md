...
* feat: New learner `fcst.snaive` provides the seasonal naive forecast with the seasonal period taken from the task frequency, rounded to the nearest integer and bounded below by one.
