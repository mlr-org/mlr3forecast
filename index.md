...
which adds lag features and forecasts recursively by default:
...
several forecasters with
[`gunion()`](https://mlr3pipelines.mlr-org.com/reference/gunion.html)
and average their forecasts with `po("regravg")`. This mirrors the idea
behind the forecastHybrid package, but with any mix of classical or ML
learners.
