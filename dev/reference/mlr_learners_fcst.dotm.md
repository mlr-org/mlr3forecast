...
Dynamic optimized theta model. Calls
[`forecTheta::dotm()`](https://rdrr.io/pkg/forecTheta/man/thetaModels.html)
from package
...
- [`LearnerFcstDotm$new()`](#method-LearnerFcstDotm-initialize)

- [`LearnerFcstDotm$clone()`](#method-LearnerFcstDotm-clone)
...
### `LearnerFcstDotm$clone()`

The objects of this class are cloneable with this method.

#### Usage

    LearnerFcstDotm$clone(deep = FALSE)
...
print(learner)
#> 
#> ── <LearnerFcstDotm> (fcst.dotm): Dynamic Optimized Theta Model ────────────────
#> • Model: -
#> • Parameters: list()
