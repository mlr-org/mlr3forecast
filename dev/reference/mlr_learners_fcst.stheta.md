...
Standard theta method. Calls
[`forecTheta::stheta()`](https://rdrr.io/pkg/forecTheta/man/thetaModels.html)
from package
...
- [`LearnerFcstStheta$new()`](#method-LearnerFcstStheta-initialize)

- [`LearnerFcstStheta$clone()`](#method-LearnerFcstStheta-clone)
...
### `LearnerFcstStheta$clone()`

The objects of this class are cloneable with this method.

#### Usage

    LearnerFcstStheta$clone(deep = FALSE)
...
print(learner)
#> 
#> ── <LearnerFcstStheta> (fcst.stheta): Standard Theta Method ────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
#> • Model: -
#> • Parameters: list()
