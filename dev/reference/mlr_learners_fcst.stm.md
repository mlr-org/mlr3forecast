...
Standard theta model. Calls
[`forecTheta::stm()`](https://rdrr.io/pkg/forecTheta/man/thetaModels.html)
from package
...
- [`LearnerFcstStm$new()`](#method-LearnerFcstStm-initialize)

- [`LearnerFcstStm$clone()`](#method-LearnerFcstStm-clone)
...
### `LearnerFcstStm$clone()`

The objects of this class are cloneable with this method.

#### Usage

    LearnerFcstStm$clone(deep = FALSE)
...
print(learner)
#> 
#> ── <LearnerFcstStm> (fcst.stm): Standard Theta Model ───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
#> • Model: -
#> • Parameters: list()
...
print(learner$model)
#> $model
#> Forecast method: Standard Theta Model 
#> 
