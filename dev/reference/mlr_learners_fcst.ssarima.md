...
State-Space ARIMA model. Supports multiple seasonal lags natively (e.g.
`lags = c(1, 24, 168)` for hourly data with daily and weekly cycles).
Calls [`smooth::ssarima()`](https://rdrr.io/pkg/smooth/man/ssarima.html)
...
- [`LearnerFcstSsarima$new()`](#method-LearnerFcstSsarima-initialize)

- [`LearnerFcstSsarima$clone()`](#method-LearnerFcstSsarima-clone)
...
print(learner)
#> 
#> ── <LearnerFcstSsarima> (fcst.ssarima): State-Space ARIMA ──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
#> • Model: -
#> • Parameters: list()
