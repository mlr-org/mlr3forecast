...
Optimized theta model. Calls
[`forecTheta::otm()`](https://rdrr.io/pkg/forecTheta/man/thetaModels.html)
from package
...
- [`LearnerFcstOtm$new()`](#method-LearnerFcstOtm-initialize)

- [`LearnerFcstOtm$clone()`](#method-LearnerFcstOtm-clone)
...
### `LearnerFcstOtm$clone()`

The objects of this class are cloneable with this method.

#### Usage

    LearnerFcstOtm$clone(deep = FALSE)
...
print(learner)
#> 
#> ── <LearnerFcstOtm> (fcst.otm): Optimized Theta Model ──────────────────────────
#> • Model: -
#> • Parameters: list()
...
print(learner$model)
#> $model
#> Forecast method: Optimised Theta Model 
#> 
