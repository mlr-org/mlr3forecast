...
Dynamic standard theta model. Calls
[`forecTheta::dstm()`](https://rdrr.io/pkg/forecTheta/man/thetaModels.html)
from package
...
| lambda     | untyped   | NULL           |                               |
| par_ini    | untyped   | \-             |                               |
| lower      | untyped   | c(-1e+10, 0.1) |                               |
| upper      | untyped   | c(1e+10, 0.99) |                               |
| opt.method | character | Nelder-Mead    | Nelder-Mead, L-BFGS-B, SANN   |

## References

Fiorucci JA, Pellegrini TR, Louzada F, Petropoulos F, Koehler AB (2016).
“Models for optimising the theta method and their relationship to state
space models.” *International Journal of Forecasting*, **32**(4),
1151–1161.
[doi:10.1016/j.ijforecast.2016.02.005](https://doi.org/10.1016/j.ijforecast.2016.02.005)
.
...
[`LearnerFcst`](https://mlr3forecast.mlr-org.com/dev/reference/LearnerFcst.md)
-\>
[`LearnerFcstForecTheta`](https://mlr3forecast.mlr-org.com/dev/reference/LearnerFcstForecTheta.md)
-\> `LearnerFcstDstm`
...
- [`LearnerFcstDstm$new()`](#method-LearnerFcstDstm-initialize)

- [`LearnerFcstDstm$clone()`](#method-LearnerFcstDstm-clone)
...
### `LearnerFcstDstm$clone()`

The objects of this class are cloneable with this method.

#### Usage

    LearnerFcstDstm$clone(deep = FALSE)
...
print(learner)
#> 
#> ── <LearnerFcstDstm> (fcst.dstm): Dynamic Standard Theta Model ─────────────────
#> • Model: -
#> • Parameters: list()
#> • Packages: mlr3, mlr3forecast, and forecTheta
...
print(learner$model)
#> $model
#> Forecast method: Dynamic Standard Theta Model 
#> 
#> Seasonal decomposition type: multiplicative 
#> 
#> Seasonal test: default 
#> 
