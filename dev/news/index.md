...
- BREAKING CHANGE: key columns are no longer features by default. Add
  the feature role back explicitly with
  `task$set_col_roles(key, add_to = "feature")` to let a global model
  specialize per series.
