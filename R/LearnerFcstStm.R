#' @title Standard Theta Model Forecast Learner
#'
#' @name mlr_learners_fcst.stm
#'
#' @description
#' Standard theta model.
#' Calls [forecTheta::stm()] from package \CRANpkg{forecTheta}.
#'
#' @templateVar id fcst.stm
#' @template learner
#'
#' @references
  ...
  public = list(
    ...
    initialize = function() {
      ...
      super$initialize(
        ...
        label = "Standard Theta Model",
        man = "mlr3forecast::mlr_learners_fcst.stm"
      )
    }
  ),
  private = list(
...
#' @include zzz.R
register_learner("fcst.stm", LearnerFcstStm)
