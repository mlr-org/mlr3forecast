  ...
  public = list(
    ...
    initialize = function() {
      param_set = ps(
        ...
        a = p_uty(default = NULL, tags = "train", custom_check = crate(function(x) check_numeric(x, null.ok = TRUE))),
        b = p_uty(default = NULL, tags = "train", custom_check = crate(function(x) check_numeric(x, null.ok = TRUE))),
        loss = p_fct(
